var DNN_Angular_Module2 = DNN_Angular_Module2 || {};

DNN_Angular_Module2.itemViewModel = function (moduleId, resx) {
    var service = {
        path: "DNN_Angular_Module2",
    ...
    var loadUsers = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var result = data[i];
            var user = new DNN_Angular_Module2.user(result.id, result.name);
...
DNN_Angular_Module2.user = function (id, name) {
    this.id = id;
    this.name = name;
}